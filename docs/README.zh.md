...
| [18-ios-client-feasibility.md](./18-ios-client-feasibility.md) | **iOS 客户端**可行性调研 + 里程碑方案（剪裁清单 / 轮询 watcher / 移动壳 / iCloud 容器 / CI 门） | ✅ M0+M1+M2 已落地 2026-08-22;M3=上架凭证门(§10/§11) |
